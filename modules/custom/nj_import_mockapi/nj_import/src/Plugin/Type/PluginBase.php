...
abstract class PluginBase extends DrupalPluginBase {
  ...
  public function __construct(array $configuration, $plugin_id, array $plugin_definition) {
    assert(isset($configuration["import_type"]) && $configuration["import_type"] instanceof ImportTypeInterface);

    $this->importType = $configuration['import_type'];
    unset($configuration['import_type']);
  ...
  /**
   * A import is being saved.
   */
  public function onImportSave(ImportInterface $import) {}

  /**
   * A import is being deleted.
   */
  public function onImportDeleteMultiple(array $imports) {}

  /**
   * The import type is being saved.
   */
  public function onImportTypeSave($update = TRUE) {}

  /**
   * The import type is being deleted.
   */
  public function onImportTypeDelete() {}
